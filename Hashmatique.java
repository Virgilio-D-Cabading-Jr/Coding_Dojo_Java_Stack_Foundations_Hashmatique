...
public class Hashmatique {
    public static void main(String[] args) {
        ...
        trackList.put("I'm a little teapot", "I'm a little teapot,\nShort and stout,\nHere is my handle\nHere is my spout\nWhen I get all steamed up,\nHear me shout,\nTip me over and pour me out!");

        System.out.println("*****************************************************");
        System.out.println("The Lyrics of Twinkle Twinkle are:\n" + trackList.get("Twinkle Twinkle"));
        System.out.println("");

        System.out.println("*****************************************************");
        System.out.println("Pull out all the track names and lyrics in the formate Track: Lyrics\n");
